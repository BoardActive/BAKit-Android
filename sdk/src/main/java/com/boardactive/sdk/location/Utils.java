...
class  Utils {
    ...
    static void sendNotification(Context context, String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(context, AdDropActivity.class);
        ...
        stackBuilder.addParentStack(AdDropActivity.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = context.getString(R.string.addrop_name);
