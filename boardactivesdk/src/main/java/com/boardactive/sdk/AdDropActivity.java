...
public class AdDropActivity extends BaseActivity implements
        SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = AdDropActivity.class.getSimpleName();
...
//    private TextView mLocationUpdatesResultView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestUpdatesButton = (Button) findViewById(R.id.request_location_updates_button);
        mRemoveUpdatesButton = (Button) findViewById(R.id.remove_location_updates_button);
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(AdDropActivity.this,
