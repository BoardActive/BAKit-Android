package com.boardactive.bakit.customViews;
...
import com.boardactive.bakit.customViewListener.ClickListenerInterface;
import com.boardactive.bakit.customViews.CustomCheckBox;
import com.boardactive.bakit.customViews.CustomDatePicker;
import com.boardactive.bakit.customViews.CustomEditText;
import com.boardactive.bakit.models.CustomAttributes;
...
//        mStockAttributes = new Stock();
        ...
        mBoardActive.getAttributes(new BoardActive.GetMeCallback() {
            @Override
